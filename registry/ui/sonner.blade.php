        ...
        <template x-for="(t, idx) in toasts" :key="t.id">
            ...
            >
                <template x-if="t.type === 'success'">
                    <x-lucide-circle-check class="text-emerald-500 mt-0.5 size-4 shrink-0"/>
                </template>
                <template x-if="t.type === 'error'">
                    <x-lucide-circle-x class="text-destructive mt-0.5 size-4 shrink-0"/>
                </template>
                <template x-if="t.type === 'warning'">
                    <x-lucide-triangle-alert class="text-amber-500 mt-0.5 size-4 shrink-0"/>
                </template>
                <template x-if="t.type === 'info'">
                    <x-lucide-info class="text-sky-500 mt-0.5 size-4 shrink-0"/>
                </template>
