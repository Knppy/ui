...
<template x-teleport="body">
    <div x-show="open" x-cloak class="fixed inset-0 z-50">
        ...
        <div
            ...
            :id="$id('ui-dialog')"
            x-ui-labelledby="{ label: '[data-slot=dialog-title]', description: '[data-slot=dialog-description]' }"
            role="dialog"
            aria-modal="true"
            tabindex="-1"
        ...
        >
            ...
            @if ($showClose)
                <button
                    ...
                    class="ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 absolute end-4 top-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none"
                >
                    <x-lucide-x />
